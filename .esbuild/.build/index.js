...
var require_productList = __commonJS({
  "data/productList.json"(exports2, module2) {
    module2.exports = [
      {
        count: 4,
...
// index.ts
var nodejs_aws_be_exports = {};
__export(nodejs_aws_be_exports, {
  getProductById: () => getProductById,
  productListHandler: () => productListHandler
});
module.exports = __toCommonJS(nodejs_aws_be_exports);

// handlers/productListHandler.ts
var productList = require_productList();
var productListHandler = async () => {
  try {
    const response = {
      statusCode: 200,
      body: JSON.stringify({
...
// handlers/getProductByIdHandler.ts
var productList2 = require_productList();
var getProductById = async (event) => {
  try {
    const pathId = event.pathParameters.productId;
    const foundProduct = await index_default_default.where(productList2, { id: pathId });
